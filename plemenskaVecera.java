...
public class TribeDinner {
	public static Semaphore dobliziSeDoKazan;
	public static Semaphore proverka;
	...
	public static void init(int numBarbers) {
		dobliziSeDoKazan= new Semaphore(3);
