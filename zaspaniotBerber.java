...
public class TemplateNumRunsAndNumInstances {
	...
	public static Semaphore cekajnadvor;
	public static Semaphore razbudi;
	public static Semaphore povikan;
	public static Semaphore shisha;
	public static Semaphore plakja;
	public static int vnatrecekale;
	public static Semaphore eli;
	public static boolean buden;
	public static Semaphore prisuten;
    /**
    ...
    public static void init(int numBarbers) {
    	cekajnadvor= new Semaphore (5);
    	razbudi= new Semaphore (0);
    	povikan=new Semaphore(0);
    	plakja=new Semaphore(0);
    	vnatrecekale=0;
    	buden=false;
    	prisuten= new Semaphore(0);
    	eli=new Semaphore(1);
